...
def test_load_sep_cycles():
    ...
    parse_update_master(core_test_filename, test_db, test_datatype, test_decoded_df)
...
def test_sep_char_dis():
    ...
    try:
        ...
        raise Exception(
            "Column labels not containing 'Charge_dQ/dV' exception not handled by asserts."
        )
...
def test_my_savgolay():
    ...
    try:
        ...
        raise Exception(
            "Polyorder must be less than windowlength exception not handled by asserts."
        )
